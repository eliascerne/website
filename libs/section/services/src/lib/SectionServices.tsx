  ...
  return (
    <section className="services section" id="services">
      <h2 className="section_title">
        {Data.language[languageJSON].services.heading}
      </h2>
      <span className="section_subtitle">
        {Data.language[languageJSON].services.subheading}
      </span>
      ...
      <div className="services_container container grid">
        ...
        <div className="services_content">
          <div>
            ...
            <h3 className="services_title">
              {Data.language[languageJSON].services.tabs[0].heading}
            </h3>
          </div>

          <span
            className="button button--flex button--small button--link services_button"
            onClick={toggleShowModal1}
          >
          ...
          <div
            className={
              'services_modal ' + (showModal1 ? 'active-modal' : undefined)
            }
          >
        ...
        <div className="services_content">
          <div>
            <UilWebGrid className="services_icon" size="24" />
            <h3 className="services_title">
              {Data.language[languageJSON].services.tabs[1].heading}
            </h3>
          </div>

          <span
            className="button button--flex button--small button--link services_button"
            onClick={toggleShowModal2}
          >
          ...
          <div
            className={
              'services_modal ' + (showModal2 ? 'active-modal' : undefined)
            }
          >
        ...
        <div className="services_content">
          <div>
            ...
            <h3 className="services_title">
              {Data.language[languageJSON].services.tabs[2].heading}
            </h3>
          </div>

          <span
            className="button button--flex button--small button--link services_button"
            onClick={toggleShowModal3}
          >
          ...
          <div
            className={
              'services_modal ' + (showModal3 ? 'active-modal' : undefined)
            }
          >
