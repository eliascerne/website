...
export function SectionHeader(props: SectionHeaderProps) {
  ...
  return (
    <header
      className={'header ' + (darkerHeader ? 'scroll-header' : undefined)}
      id="header"
    >
      <nav className="nav container">
        <a
          href="#home"
          className="nav_logo"
          onMouseOver={() => showLanguageSwitch()}
        >
          {Data.language[languageJSON].header.heading}{' '}
          <p className="country_code">{language}</p>
        </a>
        <div
          className={
            'language_switch_container ' + (languageSwitch ? undefined : 'hide')
          }
          onMouseLeave={() => hideLanguageSwitch()}
        >
        ...
        <div
          className={'nav_menu ' + (showNavMenu ? 'show-menu' : '')}
          id="nav-menu"
        >
          <ul className="nav_list grid" onClick={toggleMenu}>
            <li className="nav_item">
              <a href="#home" className="nav_link">
                <UilEstate size="19.2" className="nav_icon" />{' '}
                {Data.language[languageJSON].header.navLink1}
              </a>
            </li>

            <li className="nav_item">
              <a href="#about" className="nav_link">
                <UilUser size="19.2" className="nav_icon" />{' '}
                {Data.language[languageJSON].header.navLink2}
              </a>
            </li>

            <li className="nav_item">
              <a href="#skills" className="nav_link">
                <UilFileAlt size="19.2" className="nav_icon" />{' '}
                {Data.language[languageJSON].header.navLink3}
              </a>
            </li>

            <li className="nav_item">
              <a href="#qualification" className="nav_link">
                <UilBag size="19.2" className="nav_icon" />{' '}
                {Data.language[languageJSON].header.navLink4}
              </a>
            </li>
            ...
            <li className="nav_item">
              <a href="#services" className="nav_link">
                <UilBag size="19.2" className="nav_icon" />{' '}
                {Data.language[languageJSON].header.navLink5}
              </a>
            </li>
            ...
            <li className="nav_item">
              <a href="#contact" className="nav_link">
                <UilUser size="19.2" className="nav_icon" />{' '}
                {Data.language[languageJSON].header.navLink6}
              </a>
            </li>
          </ul>
          <UilTimes
